...
namespace AngryWasp.Helpers
{
    ...
    {
        private static readonly NumberFormatInfo DefaultNumberInfo = new NumberFormatInfo
        {
            CurrencySymbol = "",
        ...
        public static string ToCurrencyString(this BigDecimal value, int maxDigits = 4)
        {
            ...
            NumberFormatting.FormatCurrency(result,
                ...
                maxDigits: maxDigits, info: DefaultNumberInfo);
            return result.ToString();
        }

        private static IList<byte> GetDigits(this BigDecimal value, out int exponent)
        {
